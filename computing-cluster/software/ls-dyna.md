...
#NOTE: ls-dyna could also be lsdyna
#NOTE: for double precision add -dp
ls-dyna i={MODEL.key} -dp
```
#NOTE: If not in seylabis group do the following use ansys token. Instructions found [here](./ansys.md)
